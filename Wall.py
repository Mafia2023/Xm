...
x====The Speed Royal Hunter BERLIN x RONII-X'wd====x

\033[91;1m[[ AUTHOR NAME ]]       BERLIN X RONII

\033[91;1m[[ TOOL ]]            POST FIGHT WALL
...
print ("[-[ TH3 T00L CREATE BY  BERLIN X RONII ]-]")
